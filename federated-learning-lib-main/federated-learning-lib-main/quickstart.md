...
For example, run
```commandline
python examples/generate_data.py -n 2 -d mnist -pp 200  ////aggregator 
```
...
```commandline
python  examples/generate_configs.py -n 2 -m keras_classifier -d mnist -p examples/data/mnist/random/ //aggregator
```
